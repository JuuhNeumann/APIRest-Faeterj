...
public class SwaggerConfig {
	...
	public Docket api() {
		...
		return new Docket(DocumentationType.SWAGGER_2).useDefaultResponseMessages(false)
				...
				.apis(RequestHandlerSelectors.basePackage("br.edu.faeterj.api.controller")).paths(PathSelectors.any())
				.build().apiInfo(apiInfo());
	}

	private ApiInfo apiInfo() {
		return new ApiInfo("API FATERJ SO2", "Api criada para .....",
				"Versão 1.0", null,
				new Contact(
						"[GRUPO] Lucas Esteves - Julia Neumann - Vitoria ...",
						"LINK DO GIT", null),
