package cpti.faeterj.api.config;
...
public class SwaggerConfigg {
	...
	public Docket api() {
		...
		return new Docket(DocumentationType.SWAGGER_2).useDefaultResponseMessages(false)
				...
				.apis(RequestHandlerSelectors.basePackage("cpti.faeterj.api.controller")).paths(PathSelectors.any())
				.build().apiInfo(apiInfo());
	}

	private ApiInfo apiInfo() {
		return new ApiInfo("API REST Faeterj", "SO2", "Versão 1.0", null,
				new Contact("[..]", ".......", null), null, null, Collections.emptyList() // Vendor Extensions
		);
	}
